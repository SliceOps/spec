# reference/ — Layer B reference patterns, templates, and schemas

Vendor-agnostic, stack-agnostic reference material that materializes the canonical principles. SliceOps IP under CC BY 4.0 (documentation) and MIT (code templates / workflow exemplars).
