...
```
OUTC-BL05-block-outcome.md             (canonical prefix OUTC- — legacy OC-/BR- retired, see ../../spec/v2.0.1/naming.md)
  entity: OutcomeRecord
  status: closed
  kind: retrospective
  scope: block
...
- The `OC-` or `BR-` prefixes (retired — see `../../spec/v2.0.1/naming.md`).
