...
## Kind axis and goal edges (clause DEC-0008_3)
...
## Clause identifiers (clause DEC-0008_9)

Resolutions inside a record are **clauses**, cited `DEC-NNNN_n` — never "Decision n" bare. Clause identifiers are valid supersession targets (`supersedes: [DEC-0008_3]`). The independence test decides clause versus standalone record: *could you reject this part and approve the rest without breaking the design?* No → clause; yes → its own record.

## Usage example (generic)

```
DEC-NNNN-YYYYMMDD-<decision-slug>.md      (universal grammar — spec/v2.0.1/naming.md)
  entity: DecisionRecord
  status: approved
...
- The `DR-` prefix or the term "RFC" (retired — see `../../spec/v2.0.1/naming.md`).
