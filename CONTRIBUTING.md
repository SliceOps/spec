...
> **Status: contribution terms ratified 2026-06-15** (`DEC-0003-20260615-sliceops-license-ratification`). This repository is public and open to contributions; every pull request requires maintainer approval before merge (P3 — Human-in-the-Loop Authority).
