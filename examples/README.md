...
| Document | Purpose |
|---|---|
| `reference-implementations.md` | Catalog of known SliceOps runtime implementations (vendor runtimes + adapters), their Layer B compliance level, and selection guidance. Implementations are architectural peers — none is "the official" runtime. |
