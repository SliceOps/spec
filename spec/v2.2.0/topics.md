# SliceOps™ Canonical Topic Taxonomy — v2.2.0
...
- **Parent**: foundational
- **Sub-topics**: hierarchical-taxonomy, naming, consistency-management, context-discipline, vocabulary-discipline, corpus-integrity
- **Cross-references**: foundational, scalability

### naming
- **Scope**: Decisions about the canonical identifier standard (`naming.md`) — the universal grammar `PREFIX-NNNN-YYYYMMDD-slug`, one entity = one prefix, the slice coordinate, clause identifiers, reserved infrastructure names, retired prefixes, and the alias tables. This is the **identifier** axis: how artifacts are named. Term canonicity in prose — what a concept is *called* — is `vocabulary-discipline`; the Layer A/B/C layer names and sub-numbering are `hierarchical-taxonomy`.
- **Parent**: meta-framework
- **Sub-topics**: universal-grammar, entity-prefix, slice-coordinate, clause-identifier, reserved-names, alias-tables
- **Cross-references**: meta-framework, vocabulary-discipline, hierarchical-taxonomy, corpus-integrity
