...
[The 12 canonical principles](spec/v1.2.0/principles.md) · [Why a framework, not a methodology?](spec/v1.2.0/framework-not-methodology.md)
...
The IP boundary follows these layers: A and B are SliceOps IP; C belongs to the vendor or adopter. See [`spec/v1.2.0/ip-boundary.md`](spec/v1.2.0/ip-boundary.md).
