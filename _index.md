...
| Looking for | Go to |
|---|---|
| The 12 principles (Layer A) | `spec/v2.2.0/principles.md` |
| Canonical naming — prefixes, universal grammar, container layout, aliases | `spec/v2.2.0/naming.md` |
| Canonical vocabulary | `spec/v2.2.0/glossary.md` |
| Topic taxonomy | `spec/v2.2.0/topics.md` |
| Layer A/B/C IP boundary | `spec/v2.2.0/ip-boundary.md` |
