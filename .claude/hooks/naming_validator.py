...
# SliceOps Layer B.1 — naming validator (spec v1.1.0 naming.md).
...
def run_hook():
    ...
    if errs:
        sys.stderr.write(
            "SliceOps naming validator — write BLOCKED (spec v1.1.0 naming.md):\n"
...
def main():
    ap = argparse.ArgumentParser(description="SliceOps naming validator (spec v1.1.0)")
